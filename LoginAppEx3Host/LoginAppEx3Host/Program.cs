...
namespace LoginAppEx3Host
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string appletID = "d7ce28c6-592b-4f92-be18-8a970862ce5e";
            ...
            string appletPath = "C:\\Users\\user\\Desktop\\dal projects\\DalApp-Ex3\\LoginAppEx3\\bin\\LoginAppEx3.dalp";
            ...
            byte[] sendBuff = UTF32Encoding.UTF8.GetBytes(password); // A message to send to the TA
